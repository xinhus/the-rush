defmodule TheRush.PlayerData.UseCase.PlayerDataUseCaseTest do
  ...
  test "can retrieve records as JSON" do
    ...
    assert TheRush.PlayerData.UseCase.PlayerDataUseCase.getRecordsAsJson(TheRush.PlayerData.Repository.PlayerDataRepository, "", 1, 1, []) == expectedJson
  end
  ...
  test "can retrieve records as CSV" do
    ...
    assert TheRush.PlayerData.UseCase.PlayerDataUseCase.getRecordsAsCsv(TheRush.PlayerData.Repository.PlayerDataRepository, "", 1, 1, []) == expectedCsv
  end
end
