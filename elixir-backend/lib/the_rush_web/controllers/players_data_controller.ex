defmodule TheRushWeb.PlayersDataController do
  ...
  def getPlayers(conn, params) do
    conn
      ...
      |> resp(200, TheRush.PlayerData.UseCase.PlayerDataUseCase.getRecordsAsJson(TheRush.PlayerData.Repository.PlayerDataRepository, getPlayerNameParam(params), getPageParam(params), getRecordsPerPageParam(params), getOrderParam(params)))
  end
  ...
  |> resp(200,TheRush.PlayerData.UseCase.PlayerDataUseCase.getRecordsAsCsv(TheRush.PlayerData.Repository.PlayerDataRepository, getPlayerNameParam(params), getPageParam(params), getRecordsPerPageParam(params), getOrderParam(params)))
  end
